...
def render_pomodoro_timer():
    ...
    return (
        ...
        '.pomo-card { background: #ffffff; border: 1.5px solid #e2e8f0; border-radius: 16px; padding: 0.95rem 1.15rem; box-shadow: 0 4px 16px rgba(15, 23, 42, 0.04); }'
        '.pomo-header { display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #f1f5f9; padding-bottom: 0.55rem; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 6px; }'
        '.pomo-grid { display: flex; align-items: center; justify-content: center; gap: 1rem; flex-wrap: wrap; }'
        '.pomo-timer-box { flex: 0 0 125px; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; }'
        '.pomo-controls-box { flex: 1; min-width: 220px; display: flex; flex-direction: column; gap: 0.5rem; }'
        '.pomo-btn-mode { flex: 1; min-width: 70px; background: #ffffff; border: 1.5px solid #e2e8f0; border-radius: 8px; padding: 0.35rem 0.4rem; font-size: 0.74rem; font-weight: 700; color: #475569; cursor: pointer; transition: all 0.15s ease; text-align: center; }'
