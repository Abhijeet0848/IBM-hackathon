...
def render_pomodoro_timer():
    ...
    return (
        ...
        '.pomo-card { background: #ffffff; border: 1.5px solid #e2e8f0; border-radius: 16px; padding: 0.85rem 1rem 1rem 1rem; box-shadow: 0 4px 16px rgba(15, 23, 42, 0.04); margin-bottom: 4px; }'
