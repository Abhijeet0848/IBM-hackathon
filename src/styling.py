...
def render_pomodoro_timer():
    ...
    return (
        ...
        'body { font-family: "Plus Jakarta Sans", sans-serif; background: transparent; padding: 2px; }'
        '.pomo-card { background: #ffffff; border: 1.5px solid #e2e8f0; border-radius: 18px; padding: 1.25rem 1.5rem; box-shadow: 0 10px 25px -5px rgba(15, 23, 42, 0.04), 0 4px 6px -2px rgba(15, 23, 42, 0.02); }'
        '.pomo-header { display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #f1f5f9; padding-bottom: 0.75rem; margin-bottom: 1rem; flex-wrap: wrap; gap: 10px; }'
        '.pomo-grid { display: grid; grid-template-columns: 180px 1fr; gap: 1.5rem; align-items: center; }'
        '@media (max-width: 600px) { .pomo-grid { grid-template-columns: 1fr; } }'
        '.pomo-btn-mode { flex: 1; min-width: 85px; background: #ffffff; border: 1.5px solid #e2e8f0; border-radius: 9px; padding: 0.45rem 0.5rem; font-size: 0.78rem; font-weight: 700; color: #475569; cursor: pointer; transition: all 0.15s ease; }'
        ...
        '<div>'
        '<div style="font-family: \'Outfit\', sans-serif; font-size: 1.15rem; font-weight: 800; color: #0f172a;">Pomodoro Focus Arena</div>'
        '<div style="font-size: 0.78rem; color: #64748b;">Execute targeted study blocks with ambient focus audio</div>'
        '</div>'
        '</div>'
        '<div id="pomo-mode-badge" style="background: #eef2ff; color: #4f46e5; border: 1px solid #c7d2fe; border-radius: 20px; padding: 0.25rem 0.8rem; font-size: 0.76rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em;">'
        '🍅 25m Focus Block'
        '</div>'
        '</div>'
        '<div class="pomo-grid">'
        ...
        '<circle cx="75" cy="75" r="62" stroke="#f1f5f9" stroke-width="9" fill="transparent" />'
        '<circle id="pomo-progress-circle" cx="75" cy="75" r="62" stroke="url(#pomoGradient)" stroke-width="9" stroke-linecap="round" fill="transparent" stroke-dasharray="389.56" stroke-dashoffset="0" style="transition: stroke-dashoffset 0.85s linear;" />'
        '<defs>'
        ...
        '<div id="pomo-timer-display" style="font-family: \'Outfit\', monospace; font-size: 1.95rem; font-weight: 800; color: #0f172a; line-height: 1;">25:00</div>'
        '<div id="pomo-status-label" style="font-size: 0.7rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-top: 3px;">Ready to Focus</div>'
        '</div>'
        '</div>'
        '<div style="display: flex; flex-direction: column; gap: 0.65rem;">'
        '<div style="display: flex; gap: 6px; flex-wrap: wrap;">'
        '<button type="button" class="pomo-btn-mode" onclick="setPomodoroMode(25, \'🍅 25m Focus Block\', \'#4f46e5\', \'#eef2ff\')">🍅 25m Focus</button>'
        '<button type="button" class="pomo-btn-mode" onclick="setPomodoroMode(50, \'⚡ 50m Deep Work\', \'#7e22ce\', \'#faf5ff\')">⚡ 50m Deep</button>'
        '<button type="button" class="pomo-btn-mode" onclick="setPomodoroMode(5, \'☕ 5m Short Break\', \'#15803d\', \'#f0fdf4\')">☕ 5m Break</button>'
        '</div>'
        '<div style="display: flex; gap: 8px;">'
        '<button id="pomo-toggle-btn" type="button" onclick="togglePomodoroTimer()" style="flex: 2; background: linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%); color: #ffffff; border: none; border-radius: 10px; padding: 0.55rem 1rem; font-size: 0.92rem; font-weight: 700; cursor: pointer; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.28);">▶️ Start Focus Block</button>'
        '<button type="button" onclick="resetPomodoroTimer()" style="flex: 1; background: #ffffff; color: #64748b; border: 1.5px solid #cbd5e1; border-radius: 10px; padding: 0.55rem 0.75rem; font-size: 0.88rem; font-weight: 600; cursor: pointer;">🔄 Reset</button>'
        '</div>'
        '<div style="display: flex; align-items: center; justify-content: space-between; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 0.4rem 0.85rem;">'
        '<span style="font-size: 0.78rem; font-weight: 700; color: #475569;">🎧 Ambient Audio:</span>'
        '<select id="pomo-audio-select" onchange="switchAmbientSound(this.value)" style="font-size: 0.76rem; font-weight: 600; border: 1px solid #cbd5e1; border-radius: 6px; padding: 2px 6px; background: #ffffff; color: #1e293b; outline: none; cursor: pointer;">'
        ...
        '</div>'
        '</div>'
        '<div id="pomo-celebrate-box" style="display: none; margin-top: 0.85rem; background: #f0fdf4; border: 1.5px solid #86efac; border-radius: 10px; padding: 0.65rem 1rem; text-align: center; color: #15803d; font-size: 0.88rem; font-weight: 700;">'
